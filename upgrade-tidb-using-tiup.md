...
### Step 4: Check the DDL and backup status of the cluster {#step-4-check-the-ddl-and-backup-status-of-the-cluster}
...
### Step 5: Check the health status of the current cluster {#step-5-check-the-health-status-of-the-current-cluster}
...
### How to fix the issue that the upgrade gets stuck when upgrading to v6.2.0 or later versions? {#how-to-fix-the-issue-that-the-upgrade-gets-stuck-when-upgrading-to-v6-2-0-or-later-versions}
