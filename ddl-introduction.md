...
# Execution Principles and Best Practices of DDL Statements {#execution-principles-and-best-practices-of-ddl-statements}
...
## DDL execution principles {#ddl-execution-principles}
...
### Types of DDL statements {#types-of-ddl-statements}
...
### TiDB DDL module {#tidb-ddl-module}
...
### How the online DDL asynchronous change works in TiDB {#how-the-online-ddl-asynchronous-change-works-in-tidb}
...
### Balance the physical DDL execution speed and the impact on application load through system variables {#balance-the-physical-ddl-execution-speed-and-the-impact-on-application-load-through-system-variables}
...
### Quickly create many tables by concurrently sending DDL requests {#quickly-create-many-tables-by-concurrently-sending-ddl-requests}
...
### Make multiple changes in a single <code>ALTER</code> statement {#make-multiple-changes-in-a-single-code-alter-code-statement}
...
### Check the read and write performance {#check-the-read-and-write-performance}
...
## DDL-related commands {#ddl-related-commands}
