...
## Null-aware semi join (<code>IN</code> and <code>= ANY</code> subqueries) {#null-aware-semi-join-code-in-code-and-code-any-code-subqueries}
...
## Null-aware anti semi join (<code>NOT IN</code> and <code>!= ALL</code> subqueries) {#null-aware-anti-semi-join-code-not-in-code-and-code-all-code-subqueries}
...
## Explain statements using other types of subqueries {#explain-statements-using-other-types-of-subqueries}
