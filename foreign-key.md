...
## Usage examples of foreign keys {#usage-examples-of-foreign-keys}
...
## Create a foreign key constraint {#create-a-foreign-key-constraint}
...
## Delete a foreign key constraint {#delete-a-foreign-key-constraint}
...
## Foreign key constraint check {#foreign-key-constraint-check}
...
## Definition and metadata of foreign keys {#definition-and-metadata-of-foreign-keys}
...
## View execution plans with foreign keys {#view-execution-plans-with-foreign-keys}
...
### Compatibility between TiDB versions {#compatibility-between-tidb-versions}
