...
### <code>tidb_lock_unchanged_keys</code> <span class="version-mark">New in v7.1.1</span> {#code-tidb-lock-unchanged-keys-code-span-class-version-mark-new-in-v7-1-1-span}
...
### tidb_opt_enable_hash_join <span class="version-mark">New in v6.5.6 and v7.1.2</span> {#tidb-opt-enable-hash-join-span-class-version-mark-new-in-v6-5-6-and-v7-1-2-span}
...
### tidb_opt_fix_control <span class="version-mark">New in v7.1.0</span> {#tidb-opt-fix-control-span-class-version-mark-new-in-v7-1-0-span}
...
### <code>tidb_session_plan_cache_size</code> <span class="version-mark">New in v7.1.0</span> {#code-tidb-session-plan-cache-size-code-span-class-version-mark-new-in-v7-1-0-span}
