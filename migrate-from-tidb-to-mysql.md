...
# Migrate Data from TiDB to MySQL-compatible Databases {#migrate-data-from-tidb-to-mysql-compatible-databases}
...
## Step 4. Migrate services {#step-4-migrate-services}
