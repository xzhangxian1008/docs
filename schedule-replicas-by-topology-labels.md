...
### Configure <code>labels</code> for TiKV and TiFlash {#configure-code-labels-code-for-tikv-and-tiflash}
...
### (Optional) Configure <code>labels</code> for TiDB {#optional-configure-code-labels-code-for-tidb}
