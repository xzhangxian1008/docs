...
# TiDB Snapshot Backup and Restore Command Manual {#tidb-snapshot-backup-and-restore-command-manual}
...
### Restore execution plan bindings from the <code>mysql</code> schema {#restore-execution-plan-bindings-from-the-code-mysql-code-schema}
